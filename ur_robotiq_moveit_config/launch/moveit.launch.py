...
from ur_robotiq_moveit_config.launch_common import load_yaml
...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare("ur_robotiq_description"), "urdf", description_file]),
            " ",
    ...
    controllers_yaml = load_yaml("ur_robotiq_moveit_config", "config/controllers.yaml")
    ...
    servo_yaml = load_yaml("ur_robotiq_moveit_config", "config/ur_robotiq_servo.yaml")
